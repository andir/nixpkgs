...
let
  ...
  self = rec {
    ...
    # keep this here so we can generate docs for all of the attributes exposed
    # from here
    trivialBuilders = self;
    ...
    */
    ...
    /*
     * Create a C program
     * Writes a C program, compiles it and writes the binary to /nix/store/<store path>/bin/<name>.
     *
     * Example:
     * writeCBin "hello"
     *    ''
